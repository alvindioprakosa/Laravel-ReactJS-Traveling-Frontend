        ...
        {loading && <SkeletonDetail />}
        {
          <div hidden={hide}>
            ...
            <section className="px-6 md:px-64 my-8">
              <h1 className="font-semibold text-lg mb-2 text-gray-500">
                Deskripsi
              </h1>
            ...
            >
              <section className="px-6 md:px-64 flex flex-col-reverse md:flex-row justify-between items-start my-10">
                ...
                <div className="w-full md:w-1/2">
                  <h1 className="font-semibold text-lg mb-4 text-gray-500">
                    Harga
                  </h1>
            ...
            >
              <section className="px-6 md:px-64 my-[60px]">
                <h1 className="font-semibold text-lg my-5 text-gray-500">
                  Detail Lokasi
                </h1>
